...
public class SessionServlet extends HttpServlet {
    ...
    private void login(HttpServletRequest request,
        ...
        // BEGIN
        LOGGER.log(Level.INFO, "Пользователь c email " + email + " осуществил попытку логина");
        // END
        ...
        if (user == null || !user.get("password").equals(password)) {
            ...
            TemplateEngineUtil.render("session/login.html", request, response);
            LOGGER.log(Level.INFO, "Попытка логина пользователя с email  " + email + " завершилась ошибкой");
            return;
        }
        ...
        LOGGER.log(Level.INFO, "Пользователь с email  " + email + " успешно залогинился в систему");
    }
